...
| 9 | `group_preset_ext_gain` | Indicates the initial gain of the members of a metadata element group or of the element members of the group members of the referenced switch group when the corresponding preset or preset extension is selected. |`-95.5` - `32` (steps of 0.5dB)|
